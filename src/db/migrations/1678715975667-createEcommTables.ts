...
export class createEcommTables1678715975667 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cart_id" character varying NOT NULL, "user_id" uuid NOT NULL, "order_date" TIMESTAMP NOT NULL DEFAULT now(), "tax" numeric(6,2), "total_price" numeric(6,2) NOT NULL, "payment_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
